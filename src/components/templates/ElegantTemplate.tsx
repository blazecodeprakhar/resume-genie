...
export default function ElegantTemplate({ data, generated }: Props) {
  ...
  return (
    <div className="h-[1122px] overflow-hidden relative break-inside-avoid bg-[#faf9f6] text-gray-800 text-[11px] leading-relaxed" style={{ width: '794px', fontFamily: "'Georgia', serif" }}>
