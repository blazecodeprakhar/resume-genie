...
export default function AcademicTemplate({ data, generated }: Props) {
  ...
  return (
    <div className="h-[296mm] min-h-[296mm] overflow-hidden relative bg-[#fffef7] text-gray-900 text-[11px] leading-relaxed p-10" style={{ width: '210mm', fontFamily: 'Palatino Linotype, Book Antiqua, Palatino, serif' }}>
