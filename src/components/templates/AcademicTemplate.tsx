...
export default function AcademicTemplate({ data, generated }: Props) {
  ...
  return (
    <div className="min-h-[297mm] bg-[#fffef7] text-gray-900 text-[11px] leading-relaxed p-10 relative" style={{ width: '210mm', fontFamily: 'Palatino Linotype, Book Antiqua, Palatino, serif' }}>
