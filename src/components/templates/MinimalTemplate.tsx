...
export default function MinimalTemplate({ data, generated }: Props) {
  ...
  return (
    <div className="h-[297mm] min-h-[297mm] overflow-hidden relative bg-white text-gray-800 text-[11px] leading-relaxed p-10" style={{ width: '210mm', fontFamily: 'Inter, sans-serif' }}>
      {/* Header */}
      <div className="mb-8">
